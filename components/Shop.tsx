      ...
      <div className="max-w-8xl px-4 md:px-12 pt-12 md:pt-20">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center md:items-end justify-center gap-10 md:gap-16">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <div className="mt-8 mx-auto md:mx-0 w-full max-w-sm lg:max-w-xl relative border-4 border-transparent rounded-xl bg-gradient-to-b from-zinc-300 via-zinc-500 to-zinc-400 [mask-composite:exclude_padding] [mask:linear-gradient(white_0_0)] overflow-hidden">
              <video
