    ...
    <div className="relative min-h-screen overflow-x-hidden bg-black text-white font-poppins">
      <div className="container mx-auto px-4 py-16 md:py-24">
        ...
        <section className="text-center mb-16 mt-10">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">$MER Utility Token</h1>
          ...
          <div className="rounded-lg overflow-hidden mb-8">
            <div className="placeholder-image bg-gray-800 text-white py-16">Placeholder for Hero Image - 800x400</div>
          </div>
        </section>
        ...
        {/* Swap Widget Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-8 text-center">Swap SOL for $MER</h2>
        ...
        <section className="text-center mb-16">
          ...
          <div className="inline-flex items-center bg-gray-900 p-4 rounded-lg">
